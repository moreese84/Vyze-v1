...
object StudentRouterFixture {
    ...
    val DEVICE_ROWS: List<Row> = listOf(
        ...
        Row(
            ...
            jevConfidence = null,
            jevFastPathNoul = null,
            note = "dev6 promoted: app-cue garble hybrid (mic caught Analyzing + scene opener); the v3 branch this row motivated",
        ),
        Row(
            id = "dev25",
            lang = "en",
            query = "Analyzing what is here in Xian",
            previous = null,
            expected = "IGNORE",
            regexAction = "VLM_VOICE_QUERY",
            jevAction = null,
            jevConfidence = null,
            jevFastPathNoul = null,
            note = "session 2026-09-24: model-ASR rescue transcribed Vyze's own Analyzing cue + user garble; v3 hybrid branch",
        ),
        Row(
            id = "dev26",
            lang = "en",
            query = "analyzing scene",
            previous = null,
            expected = "IGNORE",
            regexAction = "VLM_VOICE_QUERY",
            jevAction = null,
            jevConfidence = null,
            jevFastPathNoul = null,
            note = "session 2026-09-24: recognizer returned Vyze's own status cue as the result; pure self-talk echo",
        ),
        Row(
            id = "dev27",
            lang = "en",
            query = "Analyzing scene. Read the label for me",
            previous = null,
            expected = "VLM_TEXT_READ",
            regexAction = "VLM_TEXT_READ",
            jevAction = null,
            jevConfidence = null,
            jevFastPathNoul = null,
            note = "v3 branch guard: a real request hidden behind a cue opener must stay routable (read keywords win)",
        ),
    )
